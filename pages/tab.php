...
<body class="bg-dark-subtle ">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="tab.php">Tabuada</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <section>
            <form method="get">
                <label for="n1" class="form-label">Digite a tabuada desejada:</label>

                <div class="mb-3">
                    <input type="number" class="form-control" id="num" name="num" aria-describedby="num" placeholder="Número" required>
                </div>
